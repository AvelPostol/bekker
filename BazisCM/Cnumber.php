...
/**
  ...
  */
      ...
      public function GetManager($data) {
          if (\Bitrix\Main\Loader::IncludeModule("main")) {
              ...
              if(isset($HDeal) && !empty($HDeal)){ // если по сделке уже есть записи
                ...
                if($ManagerID !== $HDeal['user']){ // если сменился ответственный 
                  print_r(['1']);
  ...
  $arFields['STAGE_ID'] = 'C11:NEW';
  $arFields['CATEGORY_ID'] = '11';
  $arFields['UF_CRM_1694018792723'] = 'K01177';

  $arFields['ID'] = '192358';

  $arFields['ASSIGNED_BY_ID'] = '105';
...
$arFields['STAGE_ID'] = 'C11:NEW';
  $arFields['CATEGORY_ID'] = '11';
  $arFields['UF_CRM_1694018792723'] = 'K01125';

  $arFields['ID'] = '187371';

  $arFields['ASSIGNED_BY_ID'] = '116';
  $instance = new CrmCEventy();
  $manager = $instance->GetManager([
    'deal' => $arFields,
    ]);
